<?php 
	...
	if (!isset($_SESSION['user_id'])){
			...
			window.location.href="../src/admin_login.php";
            </script>';			
		}
?>
<?php
...
<?php 
 if(isset($_POST['submit'])){
	...
	for ($i = 0; $i < count($_POST['mem_name']); $i++) {
			$id=$_POST['mem_name'][$i];
			$qry="select trainer_id from trainer_details where trainer_id='$id'";	
			...
			<div class="load-animate animated fadeInUp">
				<div class="row">
					<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8"><BR><br><br>
						<h1>&emsp;&emsp;TRAINER &nbsp; ATTENDANCE </h1>
						<HR>
					</div> 
				</div>
				<div class="" >
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<table class="table table-condensed table-striped" id="invoiceItem">
								<tr >
									...
									<th width="30%"><h3>TRAINER ID</h3></th>
								...
								<tr>
									...
									<td><input type="text" placeholder="MEMBER ID"name="mem_name[]" id="mem_name_1" class="form-control" autocomplete="off"   required ></td>

...
<?php 
 ...
 if(!empty($_GET['id']) ) {
	 $values = $data->getWorkoutedit($_GET['id']); 
}
else
	echo "error";
?>
...
<html lang="en"> 
  ...
  <div><br><br>
	...
	WORKOUT ID:
	<input type="text"  name="id" value="<?php echo $values['workout_id']; ?>" class='insty' readonly>
	
	WORKOUT NAME: 
    <input type="text" name="name" class="insty" value="<?php echo $values['name']; ?>" required >
